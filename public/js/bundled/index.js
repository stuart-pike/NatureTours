...
})({"9lKfK":[function(require,module,exports,__globalThis) {
...
},{"@babel/polyfill":"dTCHC","./leaflet":"xvuTT","./login":"7yHem","./updateSettings":"l3cGY"}],"dTCHC":[function(require,module,exports,__globalThis) {
"use strict";
...
const displayMap = (locations)=>{
    ...
    locations.forEach((loc)=>{
        ...
        L.marker([
            ...
            icon: pinIcon
        }).addTo(map).bindTooltip(`Day ${loc.day}: ${loc.description}`, {
            permanent: false,
            direction: 'bottom',
            className: 'map-label'
        });
    ...
    if (bounds.isValid()) map.whenReady(()=>{
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === 'success') (0, _alerts.showAlert)('success', `${type.toUpperCase()} data updated successfully`);
    } catch (err) {
        (0, _alerts.showAlert)('error', err.response.data.meassage);
    }
};

},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9lKfK","f2QDv"], "f2QDv", "parcelRequire11c7", {})
